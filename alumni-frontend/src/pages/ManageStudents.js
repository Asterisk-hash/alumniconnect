...
const ManageStudents = () => {
  ...
  const loadStudents = () => {
    fetch('https://alumni-connect-1e46.vercel.app/auth/students', { headers: { Authorization: `Bearer ${token}` } })
      .then(r => r.json())
  ...
  const handleAdd = async () => {
    ...
    const res = await fetch('https://alumni-connect-1e46.vercel.app/auth/register', {
      method: 'POST',
