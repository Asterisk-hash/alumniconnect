...
const ManageStudents = () => {
  ...
  const loadStudents = () => {
    fetch('https://alumniconnect-pi.vercel.app/auth/students', { headers: { Authorization: `Bearer ${token}` } })
      .then(r => r.json())
  ...
  const handleAdd = async () => {
    ...
    const res = await fetch('https://alumniconnect-pi.vercel.app/auth/register', {
      method: 'POST',
